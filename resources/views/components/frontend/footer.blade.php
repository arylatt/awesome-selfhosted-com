	...
	<div class="ui stacking divided grid">
		<div class="four column row">
			...
			<div class="column">
				...
				<p><a href="https://twitter.com/eddickson3" target="_blank" class="ui large twitter circular icon button"><i class="twitter icon"></i></a> <a href="https://github.com/Kickball/awesome-selfhosted" target="_blank" class="ui large grey circular icon button"><i class="github icon"></i></a></p>
			</div>
		</div>
	</div>
</div>